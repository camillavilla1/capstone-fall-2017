...
Another solution is to change the language from Python to The Go Programming Language\footnote{\url{https://golang.org/}}. One of Go's strongest sides is a built-in concurrency based on CSP[HOARE PAPER??]. Go is built with concurrency in mind and has goroutines instead of threads.
