...
During implementation we came across a problem with the folders containing space and UTF-8 character. An example of a folder is \textit{'/../Bilder til institutt for informatikk/åtekamera (Siw)'}. This makes it difficult to extract images because/considering/due to/for the reason that...  
