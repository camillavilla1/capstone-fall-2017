...
A dataframe\footnote{\url{https://pandas.pydata.org/pandas-docs/stable/generated/pandas.DataFrame.html}} is a two-dimensional, dynamic tabluar data structure with labeled axes (rows and columns). 
...
\textit{"Easy to use Python module to extract Exif metadata from tiff and jpeg files."}%e
...
OpenCV was started at Intel in 1999 by Gary Bradsky and it was relsased in 2000.

\textit{Currently OpenCV supports a wide variety of programming languages like C++, Python, Java etc and is available on different platforms including Windows, Linux, OS X, Android, iOS etc.}
