...
We measured the CPU utilities to \textbf{see} the CPU percentage of the system. As we can see in Figure \ref{fig:chart_cpu}, 
...
Figure \ref{fig:chart_read_count} and Figure \ref{fig:chart_read_count_since_last}.
...
Figure \ref{fig:chart_write_count} and Figure \ref{fig:chart_write_count_since_last}
