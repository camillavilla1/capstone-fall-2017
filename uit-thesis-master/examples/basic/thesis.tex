...
%MANGLER NAVN PÅ X, Y LINJER!!!!!
\textbf{Use long time. Have 4 figures showing execution time in minutes..  Most time during finding folder and read metadata and comparing.. Read excel file is faaaast!!}
...
Figure \ref{fig:time_chart_overall} show the time for the whole system to run. As we can see, w
