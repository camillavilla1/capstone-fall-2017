...
\subsubsection{Exchangeable Image File Format - EXIF}
Python module called  EXIF 2.1.2\footnote{\url{https://pypi.python.org/pypi/ExifRead}}, to extract the metadata from the jpg-files.
...
\textbf{OpenCV V2.4.9.1... provides the functionality for loading and preprocessing the images...}
...
We use Pandas dataframe to extract relevant data from the excel-files in the data storage.
