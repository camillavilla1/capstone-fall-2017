...
Samlet både metadata og excel-data så kan de sammenlignes.. 
...
The OpenCV library is used to visualize/show pictures to the user in the user application. The library read the pictures it is given and display these on the screen to the user. Our focus was not on which library 
