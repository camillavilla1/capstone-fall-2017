...
\begin{tabular}{| l | l | c |}
  \hline 
  \multicolumn{2}{|l|}{\textbf{Key}} 	& \textbf{Value}  \\
  \hline
  \multirow{\textit{Site}}	& \textit{Region}	& \textit{Image path} \\
  \hline
  \multirow{m1}	& Nordkynn	&  /.../ \\
  \hline 
\end{tabular}
\caption{My caption}
\end{table}

%/ h o m e / c a m i l l a / D o c u m e n t s / d a o s h a r e / C O A T / 2 0 1 6 - C O A T / b i l d e r / a a t e k a m e r a - s i w / f o t o b o k s 2 0 1 1 / n o r d k y n n / m 1 . 2 1 . 0 3 . 1 1 / 1 0 0 R E C N X / I M G _ 0 0 5 4 . J P G
...
The virtual sensors are implemented as functions, not threads or independent subprocesses, as mentioned in Section \ref{ssec:des_vs}. The reason for this choice is because we needed somewhere to start and this was one way to go. Lack of time prevented us to investigate other solutions with threads or subprocesses. The focus was to show images to a user and continue development as long as time didn't become an hindrance.
...
The only bar in the figure that stands out from the other, is the comparison of data from both Varanger and Nordkynn. This is because there are more data to compare and will so 
