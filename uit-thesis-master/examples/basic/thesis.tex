...
The only bar in the figure that stands out from the other, is the comparison of data from both Varanger and Nordkynn. We can see that by increasing the data size by adding another excel-file, the execution time increase ....

 comparing annotations from two files against the image's metadata, the execution time for the comparison increase by a factor of 3..
