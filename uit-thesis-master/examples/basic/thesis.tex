...
In contrast, our virtual sensors system is running on-demand, not in background/real-time....
...
%\lipsum[3-4]
This chapter will elaborate on how we implemented the system, along with stuff...

Threads, data structures, language ...
missing testing (CPU, memory, time?)


The system is implemented and written in Python 2.7\footnote{\url{https://www.python.org/}}. We made this choice because Python is highly portable among different platforms.... (frameworks available in this language??)




\section{Pandas}
Pandas (dataframe\footnote{\url{https://pandas.pydata.org/pandas-docs/stable/generated/pandas.DataFrame.html}}, \footnote{\url{http://pandas.pydata.org/pandas-docs/stable/}})
