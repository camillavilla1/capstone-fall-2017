...
As we can see in Figure \ref{fig:chart_read_count}, increases the read count during system runtime. This is because of

..and Figure \ref{fig:chart_read_count_since_last}...
